...
var id_client_element = document.getElementById("id")
var pet_element = document.getElementById("pet")
var contacNumber_element = document.getElementById("contacNumber")

let url = "http://localhost:3000/api/pets/" + pet_id; // se hace referencia al origen de los datos 
    ...
    .then(data => {
        pet_element.value = data.name
        owner_element.value = data.user.name
        lastname_element.value = data.user.lastname
        id_client_element.value = data.user.id
        contacNumber_element.value = data.user.contactNumber
